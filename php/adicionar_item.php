...
$material_carga = $_POST['material_selecionado'];
$chave = $_POST['chave'];
...
$puxar="SELECT * FROM `condutor_2cia5bbm` where material='$material_carga' ORDER BY `id` DESC LIMIT 0,1";
