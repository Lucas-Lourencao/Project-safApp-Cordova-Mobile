...
$puxar="SELECT * FROM `cadastro_viaturas` WHERE unidade='$unidade' or subunidade='$subunidade' ";
...
if ($query == true) {
	...
	if ($quantos>0){
		...
		$resultado.="<option  value='".$dados['viatura']."'>".$dados['viatura']."</option>";
		}
		...
		$resultado.="<li>
					  <div class=\"item-content\">
						<div class=\"item-inner\">
						  <div class=\"item-title\"><b>Viatura não encontrada!</b></div>
