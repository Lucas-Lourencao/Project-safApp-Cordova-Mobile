...
if ($query == true) {
		...
		$resultado .="<li>
					  <a href=\"#\" id=\"id_".$dados['id']."\" onclick=\"recebeDados(".$dados['id'].")\" class=\"item-link item-content\">
						<div class=\"item-inner item-cell\">
							<div class=\"item-row\">
							  <div class=\"item-cell\" id=\"nome_".$dados['id']."\">".$dados['CampoNome']."</div>
							  <div class=\"item-cell\" id=\"idade_".$dados['id']."\">".$dados['CampoIdade']."</div>
							  <div class=\"item-cell\" id=\"mes_".$dados['id']."\">".$dados['CampoMes']."</div>
							</div>
						</div>
					  </a>
					</li>
	...
	app.dialog.confirm('Tem certeza que quer deletar <b>".$dados['CampoNome']."</b>?','<b>CONFIRMAÇÃO</b>', function () {
				...
				app.dialog.preloader('Deletando...');
						...
						url: 'https://interappctive.com/admciabm/deletar_modelo.php',  
		...
		$resultado.="<script>
					function recebeDados(id){
						...
						var idade=$(\"#idade_\"+id).html();
						var mes=$(\"#mes_\"+id).html();
						
						$(\"#CampoNome\").val(nome);
						$(\"#CampoIdade\").val(idade);
						$(\"#CampoMes\").val(mes);
						$(\"#CampoID\").val(id);
		...
		$resultado .="<li>
					  <div class=\"item-content\">
						<div class=\"item-inner\">
						  <div class=\"item-title\"><b>Nenhum Cliente Encontrado</b></div>
