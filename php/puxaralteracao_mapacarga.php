...
//COMANDO PARA SELECIONAR TUDO DA TABELA NO BANCO alteracoes!=='' or 

$puxar="SELECT * FROM `mapacargavtr_2cia5bbm` where subunidade='$subunidade' and alteracoes!='' or conservacao='ruim' or  conservacao='inservivel' ORDER BY `ID` ASC LIMIT 0,300";
					...
					<div class='card demo-facebook-card'>
						<div class='card-header item-row'>
						    <div style='margin-right:20px;' class='col-20'>
    						    ...
    						    <span class='badge'><b>Item:</b><b id='Lista_".$dados['id']."'> ".$dados['numeracao']."</b>
    						    </span>
    						</div>
    						<div style='margin-left:30px;' class='col-80'>
    							<div class='demo-facebook-name'><b style='color:#007fff;font-size:16px;' id='Vtr_Local_".$dados['id']."'>".$dados['atividade']."</b>
    							</div>
    						</div>
    					</div></a>
    					<div class='card-footer item-row'>
						    ...
						    <div style='color:#959C9C;' class='col'><b id='Material_".$dados['id']."'>".$dados['material_equipamento']."</b>
						    </div>
						</div>
						<div class='card-footer item-row'>
