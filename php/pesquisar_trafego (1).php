...
$puxar="SELECT * FROM `trafegoviaturas` where SUBOBM_MILITAR='$subunidade' and  VIATURA LIKE '%$parametro_pesquisa%' or MILITAR LIKE '%$parametro_pesquisa%' or DATA LIKE '%$parametro_pesquisa%' or KMCHEGADA LIKE '%$parametro_pesquisa%' ORDER BY `ID` DESC LIMIT 0,10";
						    ...
						    <div class='card demo-facebook-card'>
								<div class='card-header item-row'>
									...
									<div style='margin-left:30px;' class='col-80'>
										...
										<div class='demo-facebook-date display-none left'>  <b style='color:#959C9C;font-size:16px;' id='DATA_ATUALIZ>ACAO_".$dados['ID']."'>".$dados['DATA_ATUALIZACAO']."</b></div>
									</div>
								</div></a>
