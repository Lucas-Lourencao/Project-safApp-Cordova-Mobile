...
$tmp = $_FILES['file']['tmp_name']; //caminho temporário da imagem
	...
	if (move_uploaded_file($tmp, "fotos_huc/".$nome_atual)){
			
			//GERAR LINK DA IMAGEM
			$caminho="https://interappctive.com/admciabm/fotos_huc/$nome_atual";
			
			//COMANDO PARA INSERIR NO BANCO
				$inserir="INSERT INTO `fotos_huc` (caminho) values ('$caminho')";
