...
$puxar="SELECT * FROM `areas_de_carga` WHERE subunidade='$subunidade'";
...
if ($query == true) {
	...
	if ($quantos>0){
		...
		$resultado.="<option value='".$dados['area_carga']."'>".$dados['area_carga']."</option>";
		}
		...
		$resultado.="<li>
					  <div class=\"item-content\">
						<div class=\"item-inner\">
						  <div class=\"item-title\"><b>Area de carga não encontrada!</b></div>
