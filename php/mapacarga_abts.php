...
$puxar="SELECT * FROM `mapacargavtr_2cia5bbm` where subunidade='$subunidade' and atividade='Mapa-Carga ABTS' ORDER BY `compartimento`and `numeracao` ASC LIMIT 0,300";
