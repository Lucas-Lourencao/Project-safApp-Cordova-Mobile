...
$puxar="SELECT * FROM `condutor_2cia5bbm` where subunidade='$subunidade' and alteracoes!='' or conservacao='ruim' or  conservacao='inservivel' ORDER BY `ID` ASC LIMIT 0,300";
