...
$puxar="SELECT * FROM `agenda_manutencao` where subunidade='$subunidade' ORDER BY `ID` ASC LIMIT 0,300";
		...
		$resultado .="<li style='margin-bottom:3px;border:2px solid #cccccc;border-radius:10px;'>
						...
						<div class='item-inner item-cell'>
							...
							<div style='text-transform:uppercase;' class=\"item-row\">
							  <div class='item-cell' style='color:#214ac8;font-size:14px;' ><b id='Vtr_Local_".$dados['id']."'>".$dados['servico']."</b></div>
							  <div class='item-cell' style='color:#214ac8;font-size:14px;' ><b id='Vtr_Local_".$dados['id']."'>".$dados['viatura']."</b></div>
							</div>
							<div style='text-transform:uppercase;' class=\"item-row\">
							  <div class='item-cell' style='color:#214ac8;font-size:14px;' ><b id='Vtr_Local_".$dados['id']."'>".$dados['data']."</b></div>
							  <div class='item-cell' style='color:#214ac8;font-size:14px;' ><b id='Vtr_Local_".$dados['id']."'>".$dados['km_previsto']."</b></div>
							</div>
						</div>
						</a>
					</li>";	
