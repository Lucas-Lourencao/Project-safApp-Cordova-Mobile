...
$campoViatura = $_POST['campoViatura'];
...
$inserir="INSERT INTO `condutor_2cia5bbm` (atividade,viatura,compartimento,numeracao,material,quantidade,conservacao,acao,alteracoes,unidade,subunidade,cadastrante,data_cadastro) values ('$campoAtividade','$campoViatura','$campoCompartimento','$campoNumeroItem','$campoMaterial','$campoQuantidade','$campoConservacao','$campoInspecao','$campoAlteracoes','$campoOBM','$campoSubOBM','$campoNomemilitar','$Data')";
